...
- Importez également la seconde feuille du fichier *shot_gun_dcg.xlsx* qui se nomme *phylum_raw*. Pour cela, utiliser l'aide de la fonction read_excel pour voir comment faire. 
